...
import static org.apache.cassandra.config.CassandraRelevantProperties.PROGRESS_BARRIER_BACKOFF_MILLIS;
import static org.apache.cassandra.config.CassandraRelevantProperties.PROGRESS_BARRIER_TIMEOUT_MILLIS;
...
public class InProgressSequenceCoordinationTest extends FuzzTestBase
{
    ...
    {
        try (WithProperties properties = new WithProperties(PROGRESS_BARRIER_TIMEOUT_MILLIS.getKey(), "1000",
                                                            PROGRESS_BARRIER_BACKOFF_MILLIS.getKey(), "100");
    ...
    public void replacementProgressTest() throws Throwable
    {
                                        ...
                                        .start())
        {
            ...
            new Thread(() -> {
                ...
                {
                    replacementProps.setProperty("cassandra.replace_address_first_boot",
